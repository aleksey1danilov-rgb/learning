...
# Замена эмодзи обратно на Font Awesome классы
replacements = {
    ...
    '🏷️': '<i class="fas fa-tags"></i>',
    '⚙️': '<i class="fas fa-user-cog"></i>',
...
for filename in os.listdir(folder):
    ...
    # Добавляем CSS шрифтов
    if 'fa-fonts.css' not in content and 'font-awesome.min.css' in content:
